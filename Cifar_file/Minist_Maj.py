...
#     Calculate accuracy for 256 mnist test images
    index = 0
    t_x, t_y, index = func.get_batch(batch_size, test_x, test_y, index)
    print("Testing Accuracy:", sess.run(accuracy, feed_dict={x: t_x, y: t_y, keep_prob: 1.}))
np.save('../output/cmaj_cost',np.array(cost_save))
np.save('../output/cmaj_acc', np.array(accuracy_save))
